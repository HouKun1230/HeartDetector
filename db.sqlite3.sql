...
CREATE TABLE "Website_heartrate" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "rate" integer NOT NULL, "timeSince1970" bigint NOT NULL, "user_id" integer NOT NULL REFERENCES "Website_emailaddress" ("id"));
CREATE TABLE "Website_emailaddress" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "email" varchar(500) NOT NULL, "display_name" varchar(500) NOT NULL, "address" varchar(500) NOT NULL, "phone_number" varchar(500) NOT NULL, "comments" varchar(500) NOT NULL);
...
CREATE INDEX "Website_heartrate_e8701ad4" ON "Website_heartrate" ("user_id");
COMMIT;
